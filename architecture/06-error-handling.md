...
| Ask agent | 2.5s | 0 | — | 2.5s | Falls back to plain text immediately: *"That's taking longer than it should — try again, or check the dashboard directly."* No retry, because a retry would already blow REQ-M9-08's 3s budget on its own. |
