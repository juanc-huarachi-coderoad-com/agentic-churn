...
| Observability | Structured JSON logging; OpenTelemetry traces are a Phase 2 addition once there's more than one deployment to compare | Phase 1 debugging needs are met by logs alone at this scale |
